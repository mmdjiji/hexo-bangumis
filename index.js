...
var _require = require('./dist/get-bgm-data'),
  getBgmData = _require.getBgmData;
...
hexo.extend.generator.register('bangumis', function (locals) {
  var _this$config;
  if (!(this !== null && this !== void 0 && (_this$config = this.config) !== null && _this$config !== void 0 && (_this$config = _this$config.bangumis) !== null && _this$config !== void 0 && _this$config.enable)) {
    return;
  }
...
hexo.extend.console.register('bangumis', 'Generate pages of bangumis for Hexo', options, function (args) {
  if (args.d) {
    ...
    var _this$config$bangumis = this.config.bangumis,
